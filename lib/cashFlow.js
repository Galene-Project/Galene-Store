import { periodoValido, startOfDay, endOfDay, toISODate } from './dashboardMetrics.js';
...
export function fluxoCaixa(orders, expenses, productionRuns, { startDate, endDate }) {
  ...
  orders
    .filter((o) => o.paid_at && new Date(o.paid_at) >= inicio && new Date(o.paid_at) <= fim && !NAO_CONTA_RECEITA.has(o.status))
    .forEach((o) => {
      movimentos.push({
        data: toISODate(new Date(o.paid_at)),
        tipo: 'entrada',
        categoria: 'Venda',

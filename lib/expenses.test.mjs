...
test('validateRecurringExpense: dia_geracao fora de 1-28 rejeita', () => {
  assert.throws(() => validateRecurringExpense({ categoria: 'fixas', valor: 10, dia_geracao: 29 }), /Dia de geração/);

...
export const SUBCATEGORIA_SUGESTOES = {
  producao: ['Tecido', 'Costureira', 'Insumo avulso', 'Aviamento'],
  fixas: ['Aluguel', 'Estacionamento', 'Luz', 'Internet/Telefone', 'Assinaturas', 'Contador'],
  pessoal: ['Salário', 'Pró-labore', 'Vale-transporte'],
  comissao: ['Venda'],
  logistica: ['Frete/Entrega', 'Combustível', 'Embalagem'],
  marketing: ['Fotos', 'Anúncio'],
  outras: ['Manutenção de equipamento', 'Taxas bancárias/maquininha', 'Impostos'],
};

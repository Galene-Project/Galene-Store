...
export async function fetchDashboardData() {
  const [ordersRes, itemsRes, stockRes, productsRes, custoRes, expensesRes, recurringRes] = await Promise.all([
    ...
    supabase.from('expenses').select('valor, data_competencia').order('data_competencia', { ascending: false }).limit(5000),
  ...
  return {
    ...
    estoquePorCategoria,
    raw: { orders, paidItems, custoPorProdutoId, expenses, despesaFixaMensal },
    kpis: {

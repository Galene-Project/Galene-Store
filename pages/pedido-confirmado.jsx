  ...
  return (
    <div style={{ minHeight: '100vh', background: T.bg, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Lato',sans-serif", padding: 24 }}>
      <div style={{ textAlign: 'center', maxWidth: 420 }}>
        ...
        <h1 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: 32, color: T.gold, margin: '0 0 12px' }}>Pedido recebido!</h1>
        {numero && (
        ...
        <a href="/" style={{ display: 'inline-block', background: `linear-gradient(135deg,${T.goldDk},${T.gold})`, borderRadius: 12, padding: '14px 36px', color: 'white', textDecoration: 'none', fontSize: 13, fontWeight: 700, letterSpacing: 1 }}>
          Voltar ao catálogo
        </a>
      </div>
    </div>
